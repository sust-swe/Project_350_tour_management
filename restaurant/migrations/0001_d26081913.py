    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_detail', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.UserDetail')),
            ],
        ),
        migrations.CreateModel(
            name='Orders',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user_detail', 'name', 'city'), name="user's unique restaurant in city"),
        ),
        migrations.AddConstraint(
            model_name='orders',
